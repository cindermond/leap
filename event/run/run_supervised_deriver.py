...
def main(epoch_num = 5, seed = 45, lr=0.005, eval_times = 1, batch_size = 16, model_name = "t5-small", prompt_length_enc = 4, prompt_length_dec = 4 , dataset_prefix = "entailment-bank-task-1-inf", train_extra_prefix = "657"):
    #set random seed
    random.seed(seed)
